...
!(async () => {
    ...
    const link = Math.random() > 0.5 ? 'https://raw.fastgit.org/chinnkarahoi/sc/master/shareCodes/kyd.json' : 'https://raw.fastgit.org/shufflewzc/updateTeam/main/shareCodes/kyd.json'
