...
================Loon==============
[Script]
cron "30 1,10,17 1-15 12 *" script-path=gua_opencard78.js
...
!(async () => {
  ...
  $.MixNicks = ''
  $.inviteNick = 'dwHKaIzazqguB+9QPTG1nl4tLNYA4seuA67MOIYQxEk3Vl9+AVo4NF+tgyeIc6A6kdK3rLBQpEQH9V4tdrrh0w=='
...
function taskPostUrl(url, t) {
  console.log("ffffffffffffffffffffff", t)
  const b = {
    "jsonRpc": "2.0",
    "params": {
      "commonParameter": {
