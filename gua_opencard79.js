...
================Loon==============
[Script]
cron "40 1,10,17 1-15 12 *" script-path=gua_opencard78.js
...
!(async () => {
  ...
  $.shareUuid = "02c3e5a624cb4a53bea8374037683bdb"
      ...
      case 'info':
        if(typeof res == 'object'){
          if(res.result && res.result === true){
            ...
            $.addCart = res.data.addCart ||"true
            // $.followShop = res.data.followShop ||"true
            // $.sign = res.data.isSignStatus ||"true
            // $.visitSku = res.data.visitSku ||"true
      ...
      case 'checkOpenCard':
        if(typeof res == 'object'){
          if(res.result && res.result === true){
            ...
            $.allOpenCard = res.data.allOpenCard || res.data.isOpenCardStatus ||"true
