...
async function barGain() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/chinnkarahoi/sc/master/shareCodes/jd_barGain.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/chinnkarahoi/sc@master/shareCodes/jd_barGain.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/chinnkarahoi/sc@master/shareCodes/jd_barGain.json')
  }
...
async function bigWinner() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/chinnkarahoi/sc/master/shareCodes/bigWinner.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/chinnkarahoi/sc@master/shareCodes/bigWinner.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/chinnkarahoi/sc@master/shareCodes/bigWinner.json')
  }
