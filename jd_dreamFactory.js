...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN('https://raw.githubusercontent.com/chinnkarahoi/sc/master/shareCodes/jd_updateFactoryTuanId.json')
  if (!res) res = await updateTuanIdsCDN('https://raw.fastgit.org/chinnkarahoi/sc/master/shareCodes/jd_updateFactoryTuanId.json')
