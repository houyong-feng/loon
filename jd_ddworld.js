...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/chinnkarahoi/sc/master/shareCodes/ddworld.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/chinnkarahoi/sc@master/shareCodes/ddworld.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/chinnkarahoi/sc@master/shareCodes/ddworld.json')
  }
  let res2 = await getAuthorShareCode('https://raw.githubusercontent.com/chinnkarahoi/sc/master/shareCodes/ddworld.json')
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://raw.fastgit.org/chinnkarahoi/sc/master/shareCodes/ddworld.json')
  }
